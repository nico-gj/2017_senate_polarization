...
results_2016 <- read_excel("2016_Election_Results.xlsx", 1)
...
results_2008 <- read_excel("2008_Election_Results.xlsx", 1)
...
setwd(paste(disk
            , "/Users/"
            , user
            , "/Dropbox/DataPiche/Political_Clusters_Project/Output/Intermediate_Outputs"
            , sep = ""))
